...
class _AddMealsState extends State<AddMeals> {
  ...
  Future addDietPlan() async {
    ...
    final planId = await getPlanId('diet_plan', 'nextPlanId');
    final dietPlanDoc = FirebaseFirestore.instance.collection('diet_plan').doc(planId);
    ...
    await dietPlanDoc.set(json);

    await updateNextId(planId, 'diet_plan', 'nextPlanId');
